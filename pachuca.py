...
GITHUB_REPO_API = "elnet-git/INV_pachuca"
...
class AppUnificada(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("JQ MOTORS SISTEM - Pachuca")
        self.geometry("1300x800")
        ttk.Label(self, text="🚀 JQ MOTORS PACHUCA",
...
# ==========================================================================
def iniciar_flask():
    app_flask.run(host="0.0.0.0", port=5003, debug=False)
